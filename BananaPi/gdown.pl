...
#
# very useful for google file download from terminal
# Example usage : ./gdown.pl "https://drive.google.com/uc?id=1wATkI9v5aWRElMSGDbfZy8jeT4M3toR6&export=download" ArchLinuxARM-BPI-M3-08-22-2018.img.zip
use strict;
